...
### 5.2. Test Suggestion
*   "Em đề xuất chạy `/awf:test` để confirm logic không bị ảnh hưởng."
...
3.  Khuyến nghị: "Anh chạy `/awf:test` để chắc chắn không có gì bị hỏng."
...
3️⃣ OK rồi? /awf:recap để lưu thay đổi
```
