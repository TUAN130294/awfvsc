...
📥 ĐẦU VÀO (đọc từ):
- CLAUDE.md + .claude/rules/session.json (biết đang làm feature/phase nào)
- CLAUDE.md + .claude/rules/~/.claude/CLAUDE.md (user preferences) (technical_level)
- package.json (scripts, dependencies)

📤 ĐẦU RA (update):
- CLAUDE.md + .claude/rules/session.json (status, last_run, errors)
- CLAUDE.md + .claude/rules/session_log.txt (append log)
```
...
4️⃣ Xong rồi, lưu lại → /awf:recap
